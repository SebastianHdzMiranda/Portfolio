        ...
        <div className="innovacion__contenido">
            ...
            <div className="innovacion__estadistics">
                <div className="innovacion__estadistic">
                    <svg className='innovacion__logo' xmlns="http://www.w3.org/2000/svg" width="75" height="60" viewBox="0 0 75 60" fill="none"><g clip-path="url(#clip0_2773_413)">
                    ...
                    <p className="innovacion__estadistic-text">Complete project</p>
                </div>
                <div className="innovacion__estadistic">
                    <svg className='innovacion__logo' xmlns="http://www.w3.org/2000/svg" width="75" height="60" viewBox="0 0 75 60" fill="none"><g clip-path="url(#clip0_2773_398)">
                    ...
                    <p className="innovacion__estadistic-text">Client review</p>
                </div>
            </div>
        </div>
