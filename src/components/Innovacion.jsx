    ...
    <section className='innovacion contenedor' id='contacto'>
        ...
        <div className="formulario">
            ...
            <form>
                ...
                <input className='formulario__input' type="email" placeholder='Tu Email' />
                <input className='formulario__input' type="number" placeholder='Tu Telefono' />
                <textarea className='formulario__textArea' placeholder='Mensaje...'></textarea>

                <input className='formulario__submit' type="submit" value="Enviar" />
            </form>
        </div>
    </section>
  )
